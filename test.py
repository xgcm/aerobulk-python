...
zt = 10.
zu = 10.
sst = np.full(shape, 290., order=order)
t_zt = np.full(shape, 290., order=order)
hum_zt = np.full(shape, 0.001, order=order)
u_zu = np.full(shape, 1., order=order)
v_zu = np.full(shape, -1., order=order)
slp = np.full(shape, 101000., order=order)
